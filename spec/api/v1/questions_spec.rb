...
describe 'Questions API' do
  ...
  describe 'POST /create' do
    context 'unauthorized' do
      ...
      it 'returns 401 status if access_token is invalid' do
        post "/api/v1/questions", params: { access_token: '1234', question: attributes_for(:question), format: :json }
        expect(response.status).to eq 401
      end
    end
    ...
    context 'authorized' do
      ...
      context 'with invalid attributes' do
        ...
        it "doesn't save the new question to database" do
          expect { post "/api/v1/questions", params: params }.to_not change(Question, :count)
        end
      end
    end
  end
